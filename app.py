...
def main():
    ...
    real_gps_time_0 = getgpstime(
    stop_time=stoptimes['scheduled_stop_time_0'],
    adjustment_time=stoptimes['schedule_adjustment_time_0']
    )
    real_gps_time_1 = getgpstime(
    stop_time=stoptimes['scheduled_stop_time_1'],
    adjustment_time=stoptimes['schedule_adjustment_time_1']
    )
    ...
    real_gps_time_0=real_gps_time_0,
    trip_destination_1=stoptimes['trip_destination_1'],
    scheduled_stop_time_1=stoptimes['scheduled_stop_time_1'],
    schedule_adjustment_time_1=stoptimes['schedule_adjustment_time_1'],
    real_gps_time_1=real_gps_time_1,
